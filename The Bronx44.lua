...
if getgenv().Juan_loaded then
    return
end

getgenv().Juan_loaded = true
...
if isfunctionhooked then
    if isfunctionhooked(FireServer) or isfunctionhooked(UnreliableFireServer) or isfunctionhooked(InvokeServer) and LPH_OBFUSCATED then
        return Services.Players.LocalPlayer:Kick("Juan.gg | Security : You are running another script, please disable it and execute again")
    end
end
...
do -- FrameWork
    ...
    Config.HideScreen = LPH_JIT_MAX(function(Self, Title)
        ...
        textLabel.Text = '<font color="' .. accentString .. '">Juan</font>\n' .. Title
    ...
    Config.SetText = LPH_JIT_MAX(function(Self, Text)
        if Black_UI then
            ...
            Black_UI["\nhideuiJuan"].Text = '<font color="' .. accentString .. '">Juan</font>\n' .. Text
        end
    end)
...
do -- Library
    ...
    Library = {
        ...
        Images = { -- you're welcome to reupload the images and replace it with your own links
            ...
            ["Radar"] = {"Radar.png", "https://raw.githubusercontent.com/JuanSoftworks/Assets/refs/heads/main/Radar.png?raw=true"},
            ["DiagonalLine"] = {"DiagonalLine.png", "https://raw.githubusercontent.com/JuanSoftworks/Assets/refs/heads/main/DiagonalLine.png?raw=true"},
            ["AdsClick"] = {"AdsClick.png", "https://raw.githubusercontent.com/JuanSoftworks/Assets/refs/heads/main/AdsClick.png?raw=true"},
            ["Forward"] = {"Forward.png", "https://raw.githubusercontent.com/JuanSoftworks/Assets/refs/heads/main/Forward.png?raw=true"},
            ["Skull"] = {"Skull.png", "https://raw.githubusercontent.com/JuanSoftworks/Assets/refs/heads/main/Skull.png?raw=true"},
            ["MultipleCogs"] = {"MultipleCogs.png", "https://raw.githubusercontent.com/JuanSoftworks/Assets/refs/heads/main/MultipleCogs.png?raw=true"},
            ["Tune"] = {"Tune.png", "https://raw.githubusercontent.com/JuanSoftworks/Assets/refs/heads/main/Tune.png?raw=true"},
            ["Wrench"] = {"Wrench.png", "https://raw.githubusercontent.com/JuanySoftworks/Assets/refs/heads/main/Wrench.png?raw=true"},
    ...
    Library.ChangeTheme = LPH_NO_VIRTUALIZE(function(self, Theme, Color)
        ...
        if Theme == "Accent" and Window then
            Window:SetText(string.format(
                '<font color="rgb(255,255,255)">Juan.</font><font color="rgb(%d,%d,%d)">gg</font> | %s',
                Color.R*255,
                Color.G*255,
                Color.B*255,
            ...
            Watermark:SetText(string.format('<font color="rgb(255,255,255)">Juan.</font><font color="rgb(%d,%d,%d)">gg</font> - %s - %s',Color.R*255,Color.G*255,Color.B*255, Game_Name_MarketPlaceService, os.date("%b. %d %Y, %X")))
        end
...
do
    Window = Library:Window({
        Name = '<font color="rgb(255,255,255)">Juan.</font><font color="rgb(236,23,23)">gg</font> | '..Game_Name_MarketPlaceService,
        Version = "v1.0.0",
